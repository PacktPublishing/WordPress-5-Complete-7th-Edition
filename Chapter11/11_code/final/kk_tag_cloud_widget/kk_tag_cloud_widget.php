...
function kk_tag_cloud_handler($atts, $content=null) {
	...
	$result = '';
	if ('0' != $use_css) $result .= '<div class="kk_widget_tag_cloud"><div class="kk_tagcloud">';
	if (null != $content) $result .= addslashes(strip_tags($content)).' ';
	$result .= wp_tag_cloud(apply_filters('widget_tag_cloud_args', array('taxonomy' => $tax, 'echo' => false)));
